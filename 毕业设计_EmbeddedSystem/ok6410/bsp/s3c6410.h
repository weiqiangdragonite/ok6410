...
/*******************************************************************************
* 12 - VECTORED INTERRUPT CONTROLLER
*******************************************************************************/
...
#define         VIC0FIQSTATUS       (*(volatile unsigned int *) (0x71200004))
#define         VIC1FIQSTATUS       (*(volatile unsigned int *) (0x71300004))

/* RAW INTERRUPT STATUS REGISTER, VICRAWINTR */
#define         VIC0RAWINTR         (*(volatile unsigned int *) (0x71200008))
#define         VIC1RAWINTR         (*(volatile unsigned int *) (0x71300008))
...
#define         VIC0SOFTINT         (*(volatile unsigned int *) (0x71200018))
#define         VIC1SOFTINT         (*(volatile unsigned int *) (0x71300018))

/* SOFTWARE INTERRUPT CLEAR REGISTER, VICSOFTINTCLEAR */
#define         VIC0SOFTINTCLEAR    (*(volatile unsigned int *) (0x7120001C))
#define         VIC1SOFTINTCLEAR    (*(volatile unsigned int *) (0x7130001C))

/* PROTECTION ENABLE REGISTER, VICPROTECTION */
#define         VIC0PROTECTION      (*(volatile unsigned int *) (0x71200020))
#define         VIC1PROTECTION      (*(volatile unsigned int *) (0x71300020))

/* SOFTWARE PRIORITY MASK REGISTER, VICSWPRIORITYMASK */
#define         VIC0SWPRIORITYMASK  (*(volatile unsigned int *) (0x71200024))
#define         VIC1SWPRIORITYMASK  (*(volatile unsigned int *) (0x71300024))

/* VECTOR PRIORITY REGISTER FOR DAISY CHAIN */
#define         VIC0PRIORITYDAISY   (*(volatile unsigned int *) (0x71200028))
#define         VIC1PRIORITYDAISY   (*(volatile unsigned int *) (0x71300028))

/* VECTOR ADDRESS REGISTER, VICVECTADDR[0-31] */
#define         VIC0VECTADDR        ( (volatile unsigned int *) (0x71200100))
#define         VIC1VECTADDR        ( (volatile unsigned int *) (0x71300100))

/* VECTOR PRIORITY REGISTER, VICVECTPRIORITY[0-31] */
#define         VIC0VECTPRIORITY    ( (volatile unsigned int *) (0x71200200))
#define         VIC1VECTPRIORITY    ( (volatile unsigned int *) (0x71300200))
...
#define         TCNTB2              (*(volatile unsigned int *) (0x7F006024))
#define         TCNTB3              (*(volatile unsigned int *) (0x7F006030))
#define         TCNTB4              (*(volatile unsigned int *) (0x7F00603C))

/* TIMER COMPARE REGISTER */
#define         TCMPB0              (*(volatile unsigned int *) (0x7F006010))
#define         TCMPB1              (*(volatile unsigned int *) (0x7F00601C))

/* TIMER OBSERVATION REGISTER */
#define         TCNTO0              (*(volatile unsigned int *) (0x7F006014))
#define         TCNTO1              (*(volatile unsigned int *) (0x7F006020))
#define         TCNTO2              (*(volatile unsigned int *) (0x7F00602C))
#define         TCNTO3              (*(volatile unsigned int *) (0x7F006038))
#define         TCNTO4              (*(volatile unsigned int *) (0x7F006040))
...
/* WATCHDOG TIMER INTERRUPT CLEAN(WTCLRINT) REGISTER */
